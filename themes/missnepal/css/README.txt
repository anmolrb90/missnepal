...
To use these stylesheets, rename the files and miss_nepal with the name of your theme.
...
miss_nepal-alpha-default-narrow.css  
...
miss_nepal-alpha-default-normal.css
...
miss_nepal-alpha-default-wide.css
